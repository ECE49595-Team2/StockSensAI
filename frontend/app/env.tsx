...
export const COUCHDB_URL_AUTH = process.env.NODE_ENV === "production" ? `http://${COUCHDB_USER}:${COUCHDB_PASSWORD}@database:5984` : `http://${COUCHDB_USER}:${COUCHDB_PASSWORD}@localhost:5984`;
